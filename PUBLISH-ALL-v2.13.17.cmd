...
title CaneSprout v2.13.17 - Dynamic Germplasm Counters Publish

echo.
echo ============================================================
echo   CANESPROUT v2.13.17 PUBLISH
...
if errorlevel 1 (
  git commit -m "CaneSprout v2.13.17 dynamic germplasm collection counters" || goto :fail
) else (
