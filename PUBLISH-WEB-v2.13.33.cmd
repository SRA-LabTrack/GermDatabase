...
title CaneSprout v2.13.33 - Website Variety Map Publish

echo ============================================================
echo  CANESPROUT v2.13.33 WEBSITE MAP PUBLISH
echo ============================================================
...
if errorlevel 1 git commit -m "CaneSprout v2.13.33 interactive variety map" || goto :fail
