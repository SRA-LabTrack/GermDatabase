...
title CaneSprout v2.13.12 - Responsive Toolbar Publish

set "REPO=https://github.com/SRA-LabTrack/GermDatabase.git"
set "MSG=CaneSprout v2.13.12 mobile toolbar structural no-overlap fix"

echo.
echo ============================================================
echo   CANESPROUT v2.13.12 PUBLISH
...
if not "%APPVER%"=="2.13.12" (
  echo [ERROR] This publish script expects CaneSprout v2.13.12.
...
:fail
echo.
echo [FAILED] CaneSprout v2.13.12 publish stopped. Review the error above.
exit /b 1
