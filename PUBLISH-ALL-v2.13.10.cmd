...
title CaneSprout v2.13.10 - Responsive Toolbar Publish

set "REPO=https://github.com/SRA-LabTrack/GermDatabase.git"
set "MSG=CaneSprout v2.13.10 responsive mobile toolbar fix"

echo.
echo ============================================================
echo   CANESPROUT v2.13.10 PUBLISH
...
if not "%APPVER%"=="2.13.10" (
  echo [ERROR] This publish script expects CaneSprout v2.13.10.
...
:fail
echo.
echo [FAILED] CaneSprout v2.13.10 publish stopped. Review the error above.
exit /b 1
