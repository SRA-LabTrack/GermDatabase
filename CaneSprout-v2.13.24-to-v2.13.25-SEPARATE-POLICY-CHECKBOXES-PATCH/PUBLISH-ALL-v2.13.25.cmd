...
title CaneSprout v2.13.25 - Clean Registry Status UI Publish

echo.
echo ============================================================
echo   CANESPROUT v2.13.25 PUBLISH
...
if errorlevel 1 (
  git commit -m "CaneSprout v2.13.25 separate policy agreement checkboxes" || goto :fail
) else (
