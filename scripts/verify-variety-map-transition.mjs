...
const checks = [
  ...
  ['Destination keeps an expanded tile buffer', component.includes('keepBuffer: 6')],
  ...
  ['Long redirects use a slower smooth fly animation', component.includes('duration: 1.55')],
