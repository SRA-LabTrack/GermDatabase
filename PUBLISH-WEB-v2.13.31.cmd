...
echo ============================================================
echo   CANESPROUT v2.13.31 WEBSITE PUBLISH
echo ============================================================

call npm.cmd install || goto :fail
call npm.cmd run verify:pedigree-web || goto :fail
call npm.cmd run audit:preview-data-quality || goto :fail
...
if errorlevel 1 (
  git commit -m "CaneSprout v2.13.31 preview sync and disease text cleanup" || goto :fail
) else (
