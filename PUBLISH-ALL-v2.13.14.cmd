...
title CaneSprout v2.13.14 - Collapsible Mobile Toolbar Publish

set "REPO=https://github.com/SRA-LabTrack/GermDatabase.git"
set "MSG=CaneSprout v2.13.14 mobile toolbar render hard fix"

echo.
echo ============================================================
echo   CANESPROUT v2.13.14 PUBLISH
...
if not "%APPVER%"=="2.13.14" (
  echo [ERROR] This publish script expects CaneSprout v2.13.14.
...
:fail
echo.
echo [FAILED] CaneSprout v2.13.14 publish stopped. Review the error above.
exit /b 1
