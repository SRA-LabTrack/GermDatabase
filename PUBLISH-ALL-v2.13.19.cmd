...
title CaneSprout v2.13.19 - Dynamic Germplasm Counters Publish

echo.
echo ============================================================
echo   CANESPROUT v2.13.19 PUBLISH
...
if errorlevel 1 (
  git commit -m "CaneSprout v2.13.19 dynamic germplasm collection counters" || goto :fail
) else (
