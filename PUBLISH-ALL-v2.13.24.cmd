...
title CaneSprout v2.13.24 - Clean Registry Status UI Publish

echo.
echo ============================================================
echo   CANESPROUT v2.13.24 PUBLISH
...
if errorlevel 1 (
  git commit -m "CaneSprout v2.13.24 visible privacy and terms links on login" || goto :fail
) else (
