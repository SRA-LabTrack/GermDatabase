              ...
              {request.coverage === 'single' ? (<>
                ...
                {request.period === 'monthly' && (<>
                  <label>
                    <span>Month</span>
                    <select
                      value={String(request.monthNumber || Number(String(request.month || '').slice(5, 7)) || 1)}
                      onChange={(event) => setRequest((current) => ({ ...current, monthNumber: event.target.value }))}
                    >
                  ...
                  <label>
                    ...
                    <input
                      ...
                      max="2100"
                      step="1"
                      value={request.monthYear || String(request.year || new Date().getFullYear())}
                      onChange={(event) => setRequest((current) => ({ ...current, monthYear: event.target.value }))}
                    />
                  </label>
                </>)}
