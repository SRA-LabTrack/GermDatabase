...
title CaneSprout v2.13.20 - 10-Photo Background Slideshow Publish

echo.
echo ============================================================
echo   CANESPROUT v2.13.20 PUBLISH
...
if errorlevel 1 (
  git commit -m "CaneSprout v2.13.20 10-photo background slideshow selection" || goto :fail
) else (
