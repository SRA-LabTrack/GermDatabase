...
title CaneSprout v2.13.22 - Clean Registry Status UI Publish

echo.
echo ============================================================
echo   CANESPROUT v2.13.22 PUBLISH
...
if errorlevel 1 (
  git commit -m "CaneSprout v2.13.22 clean registry status UI" || goto :fail
) else (
