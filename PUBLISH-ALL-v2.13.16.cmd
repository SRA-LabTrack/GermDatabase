...
title CaneSprout v2.13.16 - Uniform Trait Styling Publish

echo.
echo ============================================================
echo   CANESPROUT v2.13.16 PUBLISH
...
if errorlevel 1 (
  git commit -m "CaneSprout v2.13.16 uniform trait styling" || goto :fail
) else (
