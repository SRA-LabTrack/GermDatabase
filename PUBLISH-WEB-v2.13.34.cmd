...
title CaneSprout v2.13.34 - Website Variety Map Publish

echo ============================================================
echo  CANESPROUT v2.13.34 WEBSITE MAP PUBLISH
echo ============================================================
...
if errorlevel 1 git commit -m "CaneSprout v2.13.34 satellite precision variety map" || goto :fail
