param(
    [string]$ProjectPath = "D:\Germ\CaneSprout-Registry-v2.9.5"
)
...
Write-Host ""
Write-Host "CaneSprout v2.9.5 -> v2.9.6 PILLAR ORDER PATCH" -ForegroundColor Green
...
$backupRoot = Join-Path $env:TEMP "canesprout-v2.9.6-pillar-order-backup-$stamp"
...
Write-Host "New order: Characterization -> Conservation -> Utilization"
Write-Host ""
