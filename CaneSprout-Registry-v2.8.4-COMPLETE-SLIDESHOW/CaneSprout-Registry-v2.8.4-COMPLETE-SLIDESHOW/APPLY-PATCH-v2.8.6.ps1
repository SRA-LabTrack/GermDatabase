param(
    [string]$ProjectPath = "D:\Germ\CaneSprout-Registry-v2.8.5-COMPLETE"
)
...
Write-Host ""
Write-Host "CaneSprout v2.8.5 -> v2.8.6 READABILITY + FADE PATCH" -ForegroundColor Green
...
$backupRoot = Join-Path $env:TEMP "canesprout-v2.8.6-patch-backup-$stamp"
...
if (Test-Path -LiteralPath $packagePath -PathType Leaf) {
    ...
    if ($package.PSObject.Properties.Name -contains "version") {
        ...
        Write-Host "  updated: package.json version -> 2.8.6"
    }
}
