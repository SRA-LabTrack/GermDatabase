param(
    [string]$ProjectPath = "D:\Germ\CaneSprout-Registry-v2.9.8"
)
...
Write-Host ""
Write-Host "CaneSprout v2.9.8 -> v2.9.9 LIBRARY LABEL PATCH" -ForegroundColor Green
...
$backupRoot = Join-Path $env:TEMP "canesprout-v2.9.9-label-backup-$stamp"
...
Write-Host "Label changed to: SUGARCANE GERMPLASM LIBRARY"
Write-Host ""
