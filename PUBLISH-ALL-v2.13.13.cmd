...
title CaneSprout v2.13.13 - Collapsible Mobile Toolbar Publish

set "REPO=https://github.com/SRA-LabTrack/GermDatabase.git"
set "MSG=CaneSprout v2.13.13 collapsible mobile toolbar"

echo.
echo ============================================================
echo   CANESPROUT v2.13.13 PUBLISH
...
if not "%APPVER%"=="2.13.13" (
  echo [ERROR] This publish script expects CaneSprout v2.13.13.
...
:fail
echo.
echo [FAILED] CaneSprout v2.13.13 publish stopped. Review the error above.
exit /b 1
