...
title CaneSprout v2.13.36 - Website Variety Map Publish

echo ============================================================
echo  CANESPROUT v2.13.36 WEBSITE MAP PUBLISH
echo ============================================================
...
if errorlevel 1 git commit -m "CaneSprout v2.13.36 seamless variety map redirects" || goto :fail
