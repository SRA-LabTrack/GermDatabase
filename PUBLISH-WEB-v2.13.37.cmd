...
title CaneSprout v2.13.37 - Website Variety Map Publish

echo ============================================================
echo  CANESPROUT v2.13.37 WEBSITE MAP PUBLISH
echo ============================================================
...
if errorlevel 1 git commit -m "CaneSprout v2.13.37 map profile return and reusable pin fix" || goto :fail
