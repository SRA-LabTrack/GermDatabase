...
title CaneSprout v2.13.26 - Clean Registry Status UI Publish

echo.
echo ============================================================
echo   CANESPROUT v2.13.26 PUBLISH
...
if errorlevel 1 (
  git commit -m "CaneSprout v2.13.26 separate policy agreement checkboxes" || goto :fail
) else (
