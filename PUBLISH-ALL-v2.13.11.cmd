...
title CaneSprout v2.13.11 - Responsive Toolbar Publish

set "REPO=https://github.com/SRA-LabTrack/GermDatabase.git"
set "MSG=CaneSprout v2.13.11 mobile toolbar collision fix"

echo.
echo ============================================================
echo   CANESPROUT v2.13.11 PUBLISH
...
if not "%APPVER%"=="2.13.11" (
  echo [ERROR] This publish script expects CaneSprout v2.13.11.
...
:fail
echo.
echo [FAILED] CaneSprout v2.13.11 publish stopped. Review the error above.
exit /b 1
